import { Home, Users, Calendar, Wallet, User, Briefcase, CalendarDays, BarChart3, Layers } from "lucide-react";
...
export const MENTOR_NAV_ITEMS = [
  ...
  { label: "Packages", href: "/mentor/packages", icon: Layers, requiresApproval: true },
];
